...
namespace Shared.DTOs
{
    ...
    public record userDto(int Id, string Name, string Email, string Phone, string Password, string Jop, string Address, string Gender, string BirthDate, string Role, int? StationId);
