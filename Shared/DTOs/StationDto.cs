...
namespace Shared.DTOs
{
   public record StationForManubalitaion
    ...
    public record StationDto(int Id , string? Name, string? NextStation , string? Description, int TrainId);
    public record StatioForOneTrainDto(int Id, string? Name, string? NextStation, string? Description, int TrainId);
